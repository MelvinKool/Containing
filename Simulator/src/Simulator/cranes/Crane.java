...
public class Crane extends WorldObject {
    ...
    private void craneMotionDone(int wayPointIndex) {
    ...
    private void holderMotionDone(int wayPointIndex) {
    ...
    private void grabbermotionDone(int wayPointIndex) {
